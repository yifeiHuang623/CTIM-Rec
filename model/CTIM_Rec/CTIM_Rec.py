...
from .CTIM_Rec_utils import TimePositionalEncoding, ScaledSoftplus, EventSampler, \
...
class CTIM_Rec(nn.Module):
    ...
    def calculate_loss(self, batch_data):
        ...
        u_id, poi_seqs, poi_cat_seqs, time_seqs, seq_len = batch_data['user_id'], batch_data['POI_id'], batch_data['POI_catid'], batch_data['timestamps'], batch_data['mask']
        ...
        # convert to day, [0, 1], batch_size, seq_len, 1
    ...
    def predict(self, batch_data):
        ...
        # [batch_size, seq_len, num_sample]
        # accepted_dtimes, weights = self.event_sampler.draw_next_time_one_step(time_seqs=time_norm_seqs,
    ...
    def forward(self, time_seqs, poi_seqs, attention_mask, poi_cat_seq, seq_mask):
        ...
        time_diffs = torch.abs(time_seqs.unsqueeze(2) - time_seqs.unsqueeze(1))  
        ...
        enc_output = torch.cat((poi_emb, poi_cat_emb, tem_enc), dim=-1)  
...
class TemporalAttention(nn.Module):
    ...
    def forward(self, q, k, v, time_diffs, mask=None):
        ...
        time_decay = time_decay.unsqueeze(1)  
